...
export default function UploadComponent() {
  ...
  className={(() => {
    const baseClasses = 'relative flex flex-col items-center justify-center w-full h-64 p-6 border-2 border-dashed rounded-lg transition-all duration-300 ease-in-out';
    const activeClasses = isDragging ? 'border-indigo-500 bg-indigo-500/20 scale-105' : 'border-gray-400 hover:border-indigo-400 hover:bg-indigo-400/10';
